...
export default function Home() {
  ...
  const screenshots = [
    { src: '/dasbord.PNG', alt: 'WinScan Dashboard' },
    { src: '/Global Node Distribution Network.PNG', alt: 'Global Node Distribution Network' },
    { src: '/BC Relayers.PNG', alt: 'Blockchain Relayers' },
    { src: '/war-del.PNG', alt: 'Validators Dashboard' },
    { src: '/Consensus.PNG', alt: 'Consensus Information' },
    { src: '/Proposal.PNG', alt: 'Governance Proposals' },
    { src: '/State Sync Configuration.PNG', alt: 'State Sync Configuration' },
    { src: '/Asset.PNG', alt: 'Asset Management' },
    { src: '/Uptime.PNG', alt: 'Validator Uptime' }
  ];
              ...
              <div className="max-w-5xl mx-auto">
                <div className="text-center mb-16">
                  ...
                  <p className="text-gray-400 text-lg sm:text-xl max-w-2xl mx-auto leading-relaxed">
                    Interested in collaboration or partnership? We're here to help build something great.
                  </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto mb-16">
                  {/* Email Contact */}
                  <a
                    href="mailto:admin@winsnip.xyz"
                    className="group/card relative"
                  >
                    <div className="absolute inset-0 bg-white/5 rounded-2xl opacity-0 group-hover/card:opacity-100 blur-xl transition-all duration-500"></div>
                    <div className="relative bg-gradient-to-br from-gray-900 to-gray-800/50 border border-gray-800 rounded-2xl p-8 hover:border-gray-700 transition-all duration-300">
                      <div className="flex flex-col items-center text-center gap-5">
                        <div className="p-5 bg-gray-800/80 rounded-2xl border border-gray-700/50 group-hover/card:border-gray-600 transition-all">
                          <svg className="w-8 h-8 text-gray-300 group-hover/card:text-white transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                          </svg>
                        </div>
                        <div>
                          <h3 className="text-white font-bold text-xl mb-3">Email</h3>
                          <p className="text-gray-500 text-sm mb-4">Send us a message</p>
                          <p className="text-gray-300 font-medium break-all group-hover/card:text-white transition-colors">
                            admin@winsnip.xyz
                          </p>
                        </div>
                      </div>
                  ...
                  >
                    ...
                    <div className="relative bg-gradient-to-br from-gray-900 to-gray-800/50 border border-gray-800 rounded-2xl p-8 hover:border-gray-700 transition-all duration-300">
                      <div className="flex flex-col items-center text-center gap-5">
                        <div className="p-5 bg-gray-800/80 rounded-2xl border border-gray-700/50 group-hover/card:border-gray-600 transition-all">
                          <svg className="w-8 h-8 text-gray-300 group-hover/card:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221l-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.446 1.394c-.14.18-.357.295-.6.295-.002 0-.003 0-.005 0l.213-3.054 5.56-5.022c.24-.213-.054-.334-.373-.121l-6.869 4.326-2.96-.924c-.64-.203-.658-.64.135-.954l11.566-4.458c.538-.196 1.006.128.832.941z"/>
                          </svg>
                        </div>
                        <div>
                          <h3 className="text-white font-bold text-xl mb-3">Telegram</h3>
                          <p className="text-gray-500 text-sm mb-4">Chat with us instantly</p>
                          <p className="text-gray-300 font-medium group-hover/card:text-white transition-colors">
                            @winnodexx
                          </p>
                        </div>
                      </div>
                ...
                <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/40 border border-gray-800/60 backdrop-blur-sm rounded-2xl p-10">
                  <div className="grid sm:grid-cols-3 gap-8 text-center">
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <h4 className="text-white font-semibold text-base">Quick Response</h4>
                      <p className="text-gray-500 text-sm leading-relaxed">We reply within 24 hours</p>
                    </div>
                    <div className="flex flex-col items-center gap-3">
                      <div className="p-4 bg-gray-800/60 rounded-xl border border-gray-700/40">
                        <svg className="w-7 h-7 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <h4 className="text-white font-semibold text-base">Secure & Private</h4>
                      <p className="text-gray-500 text-sm leading-relaxed">Your data is protected</p>
                    </div>
                    <div className="flex flex-col items-center gap-3">
                      <div className="p-4 bg-gray-800/60 rounded-xl border border-gray-700/40">
                        <svg className="w-7 h-7 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <h4 className="text-white font-semibold text-base">Partnership Ready</h4>
                      <p className="text-gray-500 text-sm leading-relaxed">Open to collaborations</p>
                    </div>
                  </div>
                </div>
              </div>
