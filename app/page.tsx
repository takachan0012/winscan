          ...
          <>
            ...
            <section className="container mx-auto px-6 py-20">
              <div className="max-w-6xl mx-auto">
                  ...
                  <div className="relative group">
                   <div className="absolute inset-0 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-xl blur-lg group-hover:blur-xl transition-all opacity-0 group-hover:opacity-100"></div>
                    <div className="relative bg-gray-800/80 border-2 border-gray-700/70 rounded-xl p-3 backdrop-blur-sm hover:border-purple-500/50 transition-all">
                     <a href="https://onenov.xyz" target="_blank" rel="noopener noreferrer" className="block">
                      <img 
                   ...
                   <a href="https://onenov.xyz" target="_blank" rel="noopener noreferrer" className="block">
                  <h3 className="text-white font-semibold text-center mb-2 text-xs hover:text-purple-400 transition-colors">OneNov</h3>
                  </a>
                 <div className="flex justify-center gap-2">
               ...
               <a href="https://onenov.xyz" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-purple-400 transition-colors">
